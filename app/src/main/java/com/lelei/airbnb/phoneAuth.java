...
import com.lelei.airbnb.Models.Data;
...
public class phoneAuth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phone = "+254" + getIntent().getStringExtra("Phone");
            ...
            new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                public void onVerificationFailed(FirebaseException e) {
                    if (e instanceof FirebaseAuthInvalidCredentialsException) {
                        // Invalid request
                        Toast.makeText(phoneAuth.this, "Invalid phone number format.", Toast.LENGTH_LONG).show();
                    } else if (e instanceof FirebaseTooManyRequestsException) {
                        // The SMS quota for the project has been exceeded
                        Toast.makeText(phoneAuth.this, "SMS quota exceeded. Please try again later.", Toast.LENGTH_LONG).show();
                    } else {
                        // Other errors
                        Toast.makeText(phoneAuth.this, "Verification failed: " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }

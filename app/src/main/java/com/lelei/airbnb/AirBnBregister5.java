...
import com.lelei.airbnb.Models.AirBnBLogIn;

import java.util.Calendar;
import java.util.HashMap;
import java.util.Random;

public class AirBnBregister5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airbnbregister5);
        ...
        sc=(CheckBox)findViewById(R.id.sc);
            ...
            public void onClick(View view) {
                ...
                if(address()) {
                    ...
                    SessionManagerAirBnBs sh=new SessionManagerAirBnBs(AirBnBregister5.this, SessionManagerAirBnBs.USERSESSION);
                    HashMap<String,String> u=sh.returnData();
                    String n=u.get(SessionManagerAirBnBs.FULLNAME);
                    String pass=u.get(SessionManagerAirBnBs.PASS);
                    String phone=u.get(SessionManagerAirBnBs.PHONE);
                    ...
                    AirBnBLogIn hl=new AirBnBLogIn(phone12,pass,n);

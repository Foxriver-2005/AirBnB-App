...
public class AirBnBRegister extends AppCompatActivity {
    Button next, login;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airbnb_register);
    ...
    public void onBackPressed() {
        AirBnBRegister.super.onBackPressed();
    }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot d) {
                        if (d.exists()) {
                            ...
                            Intent in = new Intent(AirBnBRegister.this, AirBnBRegister2.class);
                            ...
                            ActivityOptions ac = ActivityOptions.makeSceneTransitionAnimation(AirBnBRegister.this, pair);

...
public class AirBnBRegister4 extends AppCompatActivity {
    Button next, login;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airbnb_register4);
    ...
    public boolean validatePhone() {
        ...
        if(phone1.length()==10)
            ...
            phone.setError("Need 10 characters");
            phone.requestFocus();
            return false; }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot d) {
                        if (d.exists()) {
                            ...
                            //Toast.makeText(getApplicationContext(), "+254" + phone1, Toast.LENGTH_LONG).show();
                            ...
                            Intent in=new Intent(AirBnBRegister4.this, phoneauth1.class);
                            ...
                            ActivityOptions ac = ActivityOptions.makeSceneTransitionAnimation(AirBnBRegister4.this, pair);
    ...
    public void onBackPressed() {
        AirBnBRegister4.super.onBackPressed();
    }
}
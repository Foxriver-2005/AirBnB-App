...
import com.lelei.airbnb.Adapters.divisionAdapter;
import com.lelei.airbnb.Adapters.rl1Adapter;
import com.lelei.airbnb.Adapters.rl2Adapte;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isWiConnected(DashBoard.this)) {
                    ...
                    startActivity(new Intent(getApplicationContext(), All_AirBnBs.class).putExtra("com",editText.getText().toString()));
                }
            }
        });
        ...
        FirebaseDatabase.getInstance().getReference("Hotels").child("Hotel Names").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    AirBnBShow hs=ds.getValue(AirBnBShow.class);
        ...
        SessionManagerAirBnBs sh1=new SessionManagerAirBnBs(this, SessionManagerAirBnBs.USERSESSION);
        HashMap<String,String>  hm1=sh1.returnData();
        final String phoneHotel = hm1.get(SessionManagerAirBnBs.RATING);
        plusicon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(phoneUser!=null&&phoneHotel==null){
                    ...
                    Intent in = new Intent(DashBoard.this, AirBnBRooms.class);
                    Pair pair[] = new Pair[1];
                    pair[0] = new Pair<View, String>(plusicon, "nextTra");
                    ActivityOptions ac = ActivityOptions.makeSceneTransitionAnimation(DashBoard.this, pair);
                    startActivity(in, ac.toBundle());
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if(item.getItemId()==R.id.allHotels) {
                    if (!isWiConnected(DashBoard.this)) {
                        ...
                        startActivity(new Intent(getApplicationContext(), All_AirBnBs.class).putExtra("com","no"));
                    }
                }
...
// Setting Dialog Message
                            alertDialog2.setMessage("You are not logged in. Log In and see your favorite AirBnB.");
                            alertDialog2.setIcon(R.drawable.apptitle);
                            alertDialog2.setPositiveButton("YES",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
...
// Setting Dialog Message
                        alertDialog2.setMessage("You are not logged in. Log In and book your saved AirBnB.");
                        alertDialog2.setIcon(R.drawable.apptitle);
                        alertDialog2.setPositiveButton("YES",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {

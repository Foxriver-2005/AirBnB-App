    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            FirebaseDatabase.getInstance().getReference("Hotels").child(n).addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot1) {
                                    ...
                                    SessionManagerAirBnBs sh = new SessionManagerAirBnBs(NewPassword.this, SessionManagerAirBnBs.USERSESSION);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(getIntent().getStringExtra("name").equals("hotel")){
                    startActivity(new Intent(NewPassword.this, AirBnBRooms.class));
                    finish();
                }
                else {

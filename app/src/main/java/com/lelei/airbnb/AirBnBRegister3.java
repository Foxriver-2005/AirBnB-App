...
import com.lelei.airbnb.Models.AirBnB;
...
public class AirBnBRegister3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airbnb_register3);
            ...
            ref.putFile(imgUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            SessionManagerAirBnBs sh = new SessionManagerAirBnBs(AirBnBRegister3.this, SessionManagerAirBnBs.USERSESSION);

                            sh.loginSession(name2, email, star, phone, password, des, username, dow.toString());

                            AirBnBShow hr = new AirBnBShow(name2, dow.toString());
                            db.child("Hotel Names").child(name2).setValue(hr);
                            count++;
                            AirBnB h = new AirBnB(name2, password, email, phone, des, star, username, dow.toString());
                            db.child(name2).setValue(h);
                            countingStar(star, name2, d);
                            Intent in = new Intent(getApplicationContext(), AirBnBregister5.class);

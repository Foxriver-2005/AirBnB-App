...
public class ShowAmenties extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sh= new SessionManagerAirBnBs(ShowAmenties.this, SessionManagerAirBnBs.USERSESSION);

        hm=sh.returnData();
        name1=hm.get(SessionManagerAirBnBs.RATING);
        if(name1!=null)
        {
    ...
    public void   addView()
    {
        ...
        add1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    String n=hm.get(SessionManagerAirBnBs.FULLNAME);

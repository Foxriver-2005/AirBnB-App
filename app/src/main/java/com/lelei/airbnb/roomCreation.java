...
public class roomCreation extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(layoutList.getChildCount()==0) {
                    if (g == true) {
                        Intent in = new Intent(roomCreation.this, AirBnBRooms.class);
    ...
    public void addView()
    {
        ...
        Button img = roomView.findViewById(R.id.cancel);
...
// Showing Alert Dialog
                    ...
                    ref.putFile(imgUri)
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Toast.makeText(getApplicationContext(),"Please wait for a few seconds to upload the photo.",Toast.LENGTH_LONG).show();
                                    ...
                                    sub.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            if (!se.getEditText().getText().toString().equals("") && !pr.getEditText().getText().toString().equals("") && !rn1.getEditText().getText().toString().equals("")) {
                                                SessionManagerAirBnBs sh = new SessionManagerAirBnBs(roomCreation.this, SessionManagerAirBnBs.USERSESSION);

                                                HashMap<String, String> hm = sh.returnData();
                                                String name123 = hm.get(SessionManagerAirBnBs.FULLNAME);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if((requestCode == IMAGE_REQUEST) && (resultCode == RESULT_OK) && (data.getData() != null)){
            ...
            Picasso.get().load(imgUri).into(RoomImage);

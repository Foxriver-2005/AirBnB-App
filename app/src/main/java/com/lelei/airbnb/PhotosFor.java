...
public class PhotosFor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sh =new SessionManagerAirBnBs(PhotosFor.this, SessionManagerAirBnBs.USERSESSION);
        ...
        tag1.setText("Add Photos of "+name+" AirBnB's hall, outside view and swimming pool.");
    ...
    private void addView() {
        ...
        view=getLayoutInflater().inflate(R.layout.airbnbhalls, null,false);
        ...
        if(k==1)
        {
            tag.setText("Add a photo of your AirBnB's hall");
            a.setText("Add Your AirBnB's outside view photo");
        }
        else if(k==2)
        {
            tag.setText("Add a photo of your AirBnB's outside view");
            a.setText("Add Your AirBnB's swimmingpool's photo");
        }
        else if(k==3)
        {
            no.setVisibility(View.VISIBLE);
            tag.setText("Add a photo of your AirBnB's swimmingpool");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if((requestCode == IMAGE_REQUEST) && (resultCode == RESULT_OK) && (data.getData() != null)){
            ...
            Picasso.get().load(imgUri).into(pr);

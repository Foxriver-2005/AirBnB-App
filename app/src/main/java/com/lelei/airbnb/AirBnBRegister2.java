...
public class AirBnBRegister2 extends AppCompatActivity {
    Button next, login;
    ImageView back;
    RadioGroup radio;
    RadioButton ra;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airbnb_register2);
    ...
    private void goToSignUp3() {
        if (validateStar()) {
            ...
            Intent in=new Intent(getApplicationContext(), AirBnBRegister4.class);
            ...
            ActivityOptions ac = ActivityOptions.makeSceneTransitionAnimation(AirBnBRegister2.this, pair);
    ...
    public void onBackPressed() {
        AirBnBRegister2.super.onBackPressed();
    }

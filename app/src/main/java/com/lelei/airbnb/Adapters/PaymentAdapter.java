...
import com.lelei.airbnb.OrderConfirmation;
...
public class PaymentAdapter extends RecyclerView.Adapter<PaymentAdapter.Show> {
    ...
    public void onBindViewHolder(@NonNull final PaymentAdapter.Show holder, final int i) {
        if (i + 1 == 1)
            holder.count.setText("1st Order\nSeeMore...");
        else if (i + 1 == 2)
            holder.count.setText("2nd Order\nSeeMore...");
        else if (i + 1 == 3)
            holder.count.setText("3rd Order\nSeeMore...");
        else
            holder.count.setText(i + 1 + "th Order\nSeeMore...");
